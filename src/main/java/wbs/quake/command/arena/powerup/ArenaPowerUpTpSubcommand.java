...
public class ArenaPowerUpTpSubcommand extends WbsSubcommand {
    public ArenaPowerUpTpSubcommand(WbsPlugin plugin) {
        super(plugin, "tp");
    }
    ...
    protected boolean onCommand(@NotNull CommandSender sender, @NotNull String label, @NotNull String[] args, int start) {
        ...
        Location location = arena.getPowerUpLocation(hash);
